...
namespace ele
{
    ...
    namespace log_core_impl
    {
        ...
        Logger::Logger(LogFormatter formatter, int level_filter,
                       int max_log_size) : formatter_(formatter), level_filter_(level_filter),
    ...
    ///////////////////////////////////////////////////////////////////////////////
    ELE_PRECREATED_SINGLETON_IMPL(LogCore)

    LogCore::Impl::Impl() : max_log_size_(0)
    {
    }
    ...
    ///////////////////////////////////////////////////////////////////////////////
    LogCore::LogCore() : pimpl_(new Impl())
    {
        setMaxLoggerCount();
        setMaxLogSize();
    }
